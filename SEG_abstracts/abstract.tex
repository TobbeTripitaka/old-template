...
\title{A SEG abstract template for the PINGA lab}

\renewcommand{\thefootnote}{\fnsymbol{footnote}}

\author{
    Leonardo Uieda\footnotemark[1], UERJ/Observat\'orio Nacional,
    Vanderlei C. Oliveira Jr
    and
    Val\'eria C. F. Barbosa, Observat\'orio Nacional
}

\lefthead{Uieda et al.}
\righthead{SEG abstract template}
...
This is Figure \ref{fig:composite}.
